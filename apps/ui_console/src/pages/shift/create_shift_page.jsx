...
import { create_shift } from "../../graphql/shift";
...
const CreateShiftPage = (props) => {
  const [addShift, { data }] = useMutation(create_shift);
  ...
  return (
    <div className="p-2 flex flex-col">
      <div className="px-4 text-2xl font-bold">New Shift</div>
      <EntryForm />
    </div>
  );
};
...
export default withUser(CreateShiftPage);
