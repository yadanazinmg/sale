...
import { delete_shift, get_shifts } from "../../graphql/shift";
...
const ShiftPage = (props) => {
  ...
  const handleCreate = () => {
    console.log("create");
    navigate(paths.shift_create);
  };

  const handleEdit = (id) => {
    console.log("edit", id);
    navigate(paths.getShiftEdit(id));
  };
  ...
  return (
    <div className="relative flex flex-col h-full">
      <div className="w-full flex flex-row px-6 py-0 lg:hidden place-content-center">
        <span className="text-3xl font-semibold capitalize ">Shift</span>
      </div>
      <div className="w-full grid grid-cols-3 px-4 py-2 justify-between">
        ...
        <div className="px-6 py-2 hidden lg:flex place-content-center">
          <span className="pt-2 px-2 text-3xl font-semibold capitalize ">Shift</span>
        </div>
        <div className="">&nbsp;</div>
      </div>
...
export default withUser(ShiftPage);
