...
import { DetailsExcelExport, ShiftExcelExport } from "../../helpers/excel_helper";

// const dateFormatter = (params) => {
//   return moment(params.value).format("DD/MM/YYYY");
// };

const ShiftReportPage = (props) => {
  ...
  const handleExport = () => {
    ShiftExcelExport(parkingrecord, sdate, edate);
  };
  ...
  return (
    <div className="relative flex flex-col h-full">
      <div className="w-full flex flex-row py-1 place-content-center">
        <span className="text-3xl font-semibold capitalize mb-2">Shift Report</span>
      </div>
...
export default withUser(ShiftReportPage);
